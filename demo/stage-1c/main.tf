...
module "example" {
  ...
  name = "legacy-migration-demo-stage-1c"
  create_lc = true
  lc_name = "legacy-migration-demo-stage-1c-LaunchConfiguration"
  ...
  # Auto scaling group
  asg_name                  = "legacy-migration-demo-stage-1c-AutoscalingGroup"
  ...
  tags = [
    {
        key   = "Name"
        value = "legacy-migration-demo-stage-1c"
