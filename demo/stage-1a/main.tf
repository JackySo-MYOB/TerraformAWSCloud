...
module "example" {
  ...
  name = "legacy-migration-demo-stage-1a"
  create_lc = true
  lc_name = "legacy-migration-demo-stage-1a-LaunchConfiguration"
  ...
  # Auto scaling group
  asg_name                  = "legacy-migration-demo-stage-1a-AutoscalingGroup"
  ...
  tags = [
    {
        key   = "Name"
        value = "legacy-migration-demo-stage-1a"
